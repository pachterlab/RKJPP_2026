...
\input{notebooks/figures/tcga_kirc/gene_expression/wsi/wsi_macros.tex}
...
equivalently a ceiling of $\mathrm{AUC}\le 0.68$--$0.75$ on \emph{any}
...
reach for gene $j$,
\begin{equation}
\mathrm{AUC}_j(n)\ \le\ \Phi\!\left(\sqrt{\frac{\mathcal{R}_n(R_j^Z)}{2\,\big(1-\mathcal{R}_n(R_j^Z)\big)}}\right).
...
$0.62$ is uninformative in isolation, but against an attainable ceiling of
$0.68$ it is close to everything the cohort had to give, whereas against a
...
\midrule
TCGA-KIRC (CT) & $190$ & $0.152$ & $0.370$ & $0.314$ & $0.27$ & $0.57$ & $\mathbf{0.76}$ & $0.68$\\
NSCLC (CT)     & $129$ & $0.151$ & $0.497$ & $0.429$ & $0.41$ & $0.21$ & $\mathbf{0.18}$ & $0.73$\\
ADNI (MRI)     & $702$ & $0.177$ & $0.492$ & $0.478$ & $0.47$ & $0.65$ & $\mathbf{1.20}$ & $0.75$\\
\bottomrule
\end{tabular}
...
\eqref{eq:attainable-auc} and applies per binarized genomic feature. Every entry
...
$\mathrm{AUC}\le 0.68$ --- and the per-gene validation of
...
Those observed values sit just under the $0.68$ ceiling and above the $0.59$
implied by the tighter learning-curve fit; the gap is the expected size of the
non-nested gene-selection effect that Section~\ref{sec:conclusion} already flags
...
$\mathrm{AUC}\le0.68$--$0.75$, which is where the per-gene AUCs of
